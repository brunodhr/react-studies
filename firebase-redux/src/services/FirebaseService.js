...
export default class FirebaseService {
  ...
  static createUser = (email, password) => {
    return firebaseImpl.createUserWithEmailAndPassword(email, password)
  }

  static login = (email, password) => {
    return firebaseImpl.signInWithEmailAndPassword(email, password)
  }

  static logout = () => {
    return firebaseImpl.signOut()
  }

  static onAuthChange = (callbackLogin, callbackLogout) => {
    firebaseImpl.onAuthStateChanged(authUser => {
      if (!authUser) {
